...
from yolo.yolov3.yolov4 import *
...
def Load_Yolo_model(classes=YOLO_COCO_CLASSES, weights=YOLO_V3_WEIGHTS):
    ...
    if YOLO_FRAMEWORK == "tf": # TensorFlow detection
        ...
        Darknet_weights = weights
        if YOLO_CUSTOM_WEIGHTS == False:
            print("Loading Darknet_weights from:", Darknet_weights)
            yolo = Create_Yolo(input_size=YOLO_INPUT_SIZE, CLASSES=classes)
